...
# param phenotypic_marker_name -- name of phenotypic marker (e.g. "Sytox Green")
# param target -- name of target
plot_pathway_hilight_target <- function(df, confidence_intervals, phenotypic_marker_name, target) {
...
plot_target_clusters <- function(data_w_clusters, target, phenotypic_marker_name) {
