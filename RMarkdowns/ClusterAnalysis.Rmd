...
# Cluster data
sytoxG_data_w_clusters <- get_data_w_clusters(confluency_sytoxG_data_prelim_proc, sytoxG_data, "SG", 12)
...
# Cluster data
con_data_w_clusters <- get_data_w_clusters(confluency_sytoxG_data_prelim_proc, confluency_data, "Con", 12)
# Confidence interval bounds
