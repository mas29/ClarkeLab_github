...
phenotypicMarkerNames[1] <- "Con"
phenotypicMarkerNames[2] <- "SG"
#phenotypicMarkerNames[3] <- "NLS"
...
screenName <- "C2C12 Diff Tunicamycin"
...
reconfigureCompoundNames <- function() {
	cmpNameKey <- loadWorkbook("/Users/dixonlabcraig/Downloads/1833Key.xlsx")
	tempList <- list()
...
getDescriptions<- function(){
	...
	descriptionKey <- read.xls("/Users/dixonlabcraig/Box Sync/Selleck__Bioactive-Compound-Library-1833_condensed.xlsx",sheet=2)
...
getRawData <- function(){
	...
	wb <- loadWorkbook("/Users/dixonlabcraig/Box Sync/C2C12_diff_Tunicamycin_Reconfigure.xlsx")
...
#print(toXL)
write.csv(toXL,file = "C2C12_tunicamycin_output.csv")
